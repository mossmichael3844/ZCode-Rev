...
const zhCN: Record<string, string> = {
  ...
  "settings.backup.description": "将工作区快照备份到您自己的阿里云 OSS",
  "settings.backup.enabled": "启用自动备份",
  "settings.backup.enabledDescription":
    "启用后，工作区快照将自动备份到您配置的 OSS Bucket",
  "settings.backup.oss": "OSS 存储配置",
  "settings.backup.oss.accessKeyId": "AccessKey ID",
  "settings.backup.oss.accessKeySecret": "AccessKey Secret",
  "settings.backup.oss.bucket": "Bucket 名称",
  "settings.backup.oss.endpoint": "Endpoint",
  "settings.backup.oss.prefix": "对象键前缀",
  "settings.backup.encryption": "加密配置",
  "settings.backup.encryption.mode": "加密模式",
  "settings.backup.encryption.modeAes": "AES-256-CTR",
  "settings.backup.encryption.modeNone": "不加密",
  "settings.backup.encryption.passphrase": "加密密码",
  "settings.backup.encryption.passphraseDescription":
    "用于加密备份的密码，请妥善保管。丢失密码将无法解密备份。",
  "settings.backup.filter": "文件过滤",
  "settings.backup.filter.includeGitDir": "包含 .git 目录",
  "settings.backup.filter.includeGitDirDescription": "备份完整的 Git 历史记录",
  "settings.backup.filter.includeGitLfs": "包含 Git LFS 缓存",
  "settings.backup.filter.includeGitLfsDescription": "备份 Git LFS 管理的大文件",
  "settings.backup.manual": "手动备份",
  "settings.backup.manualDescription": "立即执行一次工作区备份",
  "settings.backup.manualButton": "立即备份",
  "settings.backup.manualTriggered": "备份任务已触发",
